...
# Model configuration
MODEL_CONFIG = {
    'n_estimators': 300,             # More trees → smoother variance
    'max_features': 0.5,             # Random subset of features → less overfit
    'min_samples_split': 10,          # Prevent very deep overfit splits
    'min_samples_leaf': 5,           # Slight regularization
